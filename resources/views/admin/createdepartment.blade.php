...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link " href="{{ route('admin.createdepartmentpg') }}">
                    <i class="bi bi-grid"></i>
...
<form action="{{ route('admin.createdepartment') }}" method="POST">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="inputName" name="Dname">
        </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="inputName" name="division">
        </div>
    </div>

    <div class="row mb-3">
        <label for="incharge" class="col-sm-2 col-form-label">Incharge</label>
        <div class="col-sm-10">
            <select name="incharge_id" id="incharge" class="form-control">
                <option value="">Select Incharge</option>
                @foreach($inchargeNames as $id => $name)
